      ...
      children:<Widget> [
        ...
        TextFormField(
          ...
          validator: (girilenDeger){
            return girilenDeger.trim().length <=3 ? "Kullanıcı adı en az 4 Karakter olmalıdır":null;
          },
        ...
        TextFormField(
          ...
          validator: (girilenDeger){
            return girilenDeger.trim().length > 100 ? "100 Karakterden fazla olmamalıdır":null;
          },
          onSaved:  (girilenDeger){
