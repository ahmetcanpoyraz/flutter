...
import 'package:socialapp2/sayfalar/tekligonderi.dart';
        ...
        builder: (context, snapshot){
          ...
          return ListTile(
            leading: InkWell(
              ...
              child: CircleAvatar(
                backgroundImage: aktiviteYapan.fotoUrl.isNotEmpty ? NetworkImage(aktiviteYapan.fotoUrl) : AssetImage("assets/images/hayalet.png"),
              ),
            ),
            title: RichText(
              text: TextSpan(
